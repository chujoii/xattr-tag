...
(define *zsh-completion-file* (string-append *XDG_CONFIG_HOME* "/zsh/completion/_xattr-tag"))
...
(define *list-xattr-tag-file* (string-append *XDG_CACHE_HOME* "/xattr-tag/list-xattr-tag.scm"))
